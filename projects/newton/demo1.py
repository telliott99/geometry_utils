...
geo.fill_polygon(ax,pL,fc='r',alpha=0.2)
...
geo.fill_polygon(ax,[A,F,H],fc='b',alpha=0.25)
geo.fill_polygon(ax,[C,D,H],fc='b',alpha=0.25)
...
aL = [[D,A,B],[D,C,F]]
geo.mark_angles(ax,aL,d=6,c='b')

#----------

geo.scatter_points(ax,[A,B,C,H],s=4)
